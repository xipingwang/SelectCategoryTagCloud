...
config. CloseBtnColors	= ['#c21731', '#FFFFFF', '#DD3333', '#FFFFFF']	  // [Background, text, hovered background, hovered text] - use empty strings '' to inherit title colors
...
config. Title			= 'Category Selection Help'		// Default title text applied to all tips (no default title: empty string '')
